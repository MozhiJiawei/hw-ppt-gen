...
const feedback = diagnosticsToFeedbackIssues([
  { code: "layout_manager_fallback", severity: "error", message: "fallback", target: { selector: "Slide > TwoColumn:nth-child(1) > Module:nth-child(1) > EvidenceFigure:nth-child(1)" } },
...
assert.equal(feedback[0].target.selector, "Slide > TwoColumn:nth-child(1) > Module:nth-child(1) > EvidenceFigure:nth-child(1)");
